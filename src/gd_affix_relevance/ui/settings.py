    ...
    def __init__(
        ...
        *,
        ...
        self.localization_location_combo.addItem(
            t("settings.localization_location_auto"),
            LOCALIZATION_LOCATION_AUTO,
        )
        self.localization_location_combo.addItem(
            t("settings.localization_location_installation"),
            LOCALIZATION_LOCATION_INSTALLATION,
        )
        self.localization_location_combo.addItem(
            t("settings.localization_location_user"),
            LOCALIZATION_LOCATION_USER,
        )
        ...
        form.addRow(
            t("settings.localization_location_row"),
            self.localization_location_combo,
        )
        ...
        location_note = QLabel(t("settings.localization_location_note"), self)
        location_note.setObjectName("pageHint")
